...
public class Course {
    ...
    public static void main(String[] args) {
        // Creating students
        Student student1 = new Student("John", "Doe", 1001, 75, 2);
        Student student2 = new Student("Alice", "Smith", 1002, 58);
        Student student3 = new Student("Bob", "Johnson", 1003);

        // Creating a course
        Course mathCourse = new Course("Mathematics", "Professor X", 2023);
        ...
        Student[] moreStudents = {new Student("Eva", "Williams", 1004), new Student("Michael", "Brown", 1005)};
